          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                  <input type="hidden" class="form-control" name="cart_id"  value="<?php echo $row_list['cart_id']; ?>"  required>
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        ...
                        ?>
                        <option value="<?php echo $row_product["product_id"];?>" <?php echo $select_1;?>><?php echo $row_product["product_name"];?></option>
                        <?php } ?>
                        </select>
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label>Qty</label>
                        <input type="number" min="1" max="3" name="product_qty" value="<?php echo $row_list["product_qty"];?>"  class="form-control" placeholder="Enter Product Qty" required="">
                      </div>
                    </div>
...
if (isset($_POST['update'])) {
  ...
  $id = mysqli_real_escape_string($connection, $_POST['cart_id']);
  ...
  $product_qty = mysqli_real_escape_string($connection, $_POST['product_qty']);     
   ...
   $query_check = mysqli_query($connection, "select  * from $table where product_id='{$product_id}' and user_id='{$user_id}' and NOT $primary_key = '{$id}'") or die(mysqli_error($connection));
...
{ $msg = "Product Already Added In Cart";
  ...
  $queryupdate = mysqli_query($connection, "update $table set `product_id`='{$product_id}',`user_id`='{$user_id}',`product_qty`='{$product_qty}' where $primary_key='{$id}'") or die(mysqli_error($connection));
