                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <img src="<?php echo $imageupload_path; ?>noimage.png" style="width:50px;height:50px;">
                                                    </td>
                                                <?php
                                                        } else {
                                                ?>
                                                    <img src="<?php echo $imageupload_path; ?><?php echo $row['category_image']; ?>" style="width:50px;hieght:50px;"></td>
                                                <?php
                                                        }
