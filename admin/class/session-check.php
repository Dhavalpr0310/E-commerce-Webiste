...
if (isset($_SESSION["adminemail"])) {
    ...
    $selectadminq = mysqli_query($connection, "select * from tbl_admin where admin_email='{$email}'") or die(mysqli_error($connection));
    ...
    $admin_profile  =    $admin_login_details["admin_photo"];
