                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($query_list)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo $edit_link;?>?eid=<?php echo  $row['payment_method_id']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-alt"></i></a>
                                                    <button class="btn btn-danger btn-xs delete_record" type="button" name="submit"  value="<?php echo  $row['payment_method_id']; ?>"><i class="fa fa-trash"></i></button>
                                                    </td>
