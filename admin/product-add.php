...
<body class="hold-transition sidebar-mini layout-fixed">
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          ...
                          <select name="brand_id" class="form-control">
                            ...
                            while ($row_cat = mysqli_fetch_array($query_cat)) {
                            ?>
                              <option value="<?php echo $row_cat["brand_id"]; ?>"><?php echo $row_cat["brand_name"]; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
      ...
      $queryins = mysqli_query($connection, "insert into $table(`product_name`,`product_quantity`,`product_price`,`product_details`,`category_id` ,`product_image`,`is_seller_all`,`brand_id`) VALUES ('{$product_name}','{$product_quantity}','{$product_price}','{$product_details}','{$category_id}','{$cimg}','{$is_seller_all}','{$brand_id}')") or die(mysqli_error($connection));
