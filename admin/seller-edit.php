...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="seller_first_name" value="<?php echo $row_list['seller_first_name']; ?>" class="form-control" placeholder="Enter Username" required="">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          <label>Email</label>
                          <input type="text" name="seller_email" value="<?php echo $row_list['seller_email']; ?>" class="form-control" placeholder="Enter Product Name" required="">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          <label>Mobile</label>
                          <input type="number" maxlength="10" minlength="10" name="seller_mobile_no" value="<?php echo $row_list['seller_mobile_no']; ?>" class="form-control" placeholder="Enter Mobile No" required="">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" name="seller_password" minlength="6" value="<?php echo $row_list['seller_password']; ?>" class="form-control" placeholder="Enter Password" required="">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          ...
                          <select name="is_verify" class="form-control">
                            <option value="<?php echo $row_list['is_verify']; ?>"><?php echo $row_list['is_verify'] == 1 ? "Yes" : "No"; ?></option>
  ...
  if (isset($_POST['update'])) {
    ...
    if ($count > 0) {
      ...
      $queryupdate = mysqli_query($connection, "update $table set `seller_first_name`='{$seller_first_name}',`seller_email`='{$seller_email}',`seller_gender`='{$seller_gender}',`seller_mobile_no`='{$seller_mobile_no}',`seller_password`='{$seller_password}',`seller_address`='{$seller_address}',`seller_image`='{$cimg}',`is_verify`='{$is_verify}' where $primary_key='{$id}'") or die(mysqli_error($connection));
