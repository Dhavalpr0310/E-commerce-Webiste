                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($query_list)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $x++; ?></td>
                                                     <td><?php echo $row["seller_first_name"];?></td>
                                                     <td><?php echo $row["seller_gender"];?></td>
                                                     <td><?php echo $row["seller_email"];?></td>
                                                     <td><?php echo $row["seller_mobile_no"];?></td>
                                                     <td>
                                                     <?php 
                                                     if($row['seller_image'] == "")
                                                     {
                                                        ...
                                                        <?php
                                                         ...
                                                         ?>
                                                         <img src="<?php echo $imageupload_path.$row['seller_image']; ?>" style="width:50px;height:50px;"></td>
                                                         <?php
                                                     }
                                                    ...
                                                    <td><a href="<?php echo $edit_link;?>?eid=<?php echo  $row['seller_id']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-alt"></i></a>
                                                    <button class="btn btn-danger btn-xs delete_record" type="button" name="submit"  value="<?php echo  $row['seller_id']; ?>"><i class="fa fa-trash"></i></button>
                                                    </td>
