                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="status_name"  class="form-control" placeholder="Enter Status Name" required="">
                      </div>
                    </div>
...
if (isset($_POST['submit'])) {
  ...
  $query_check = mysqli_query($connection, "select lower(status_name) from $table where status_name=lower('{$status_name}')") or die(mysqli_error($connection));
...
if($count>0)
{
  ...
  $queryins = mysqli_query($connection, "insert into $table(`status_name`) VALUES ('{$status_name}')") or die(mysqli_error($connection));
