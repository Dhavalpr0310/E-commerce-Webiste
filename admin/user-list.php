                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($query_list)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $x++; ?></td>
                                                     ...
                                                     if($row['user_photo'] == "")
                                                     {
                                                        ...
                                                        <?php
                                                         ...
                                                         ?>
                                                         <img src="<?php echo $imageupload_path.$row['user_photo']; ?>" style="width:50px;height:50px;"></td>
                                                         <?php
                                                     }
                                                    ...
                                                    <td><a href="<?php echo $edit_link;?>?eid=<?php echo  $row['user_id']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-alt"></i></a>
