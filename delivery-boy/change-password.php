...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <form role="form" id="change-password" method="post" action="#" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <input type="hidden" class="form-control" name="delivery_person_id" value="<?php echo $delivery_person_id; ?>" required>
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($_SESSION["delivery_person_password"] == $opass) {
      if ($npass == $cpass) {

        if ($npass == $_SESSION["delivery_person_password"]) {
  ...
  ?>
          ...
          $query = mysqli_query($connection, "update $table set delivery_person_password ='{$npass}' where $primary_key='{$editid}'") or die(mysqli_error($connection));
