...
if (isset($_POST['change_details'])) {
    ...
    if ($update) {
        ...
        echo "<script>alert('Something wrong while update profile.');window.location='index.php';</script>";
    }
}
    ...
    if ($user_password == $cur_password) {
        if ($new_password == $conf_password) {
            if ($new_password != $cur_password) {
                ...
                if ($update) {
                    session_destroy();
                    echo "<script>alert('Password Change Successfully.You have to login again.');window.location='index.php';</script>";
                } else {
                    echo "<script>alert('Something wrong while update profile.');window.location='index.php';</script>";
                }
            } else {
                echo "<script>alert('Your new password and current password must be different.');</script>";
            }
        } else {
            echo "<script>alert('Your New Password and Confirm Password Mot Match.');</script>";
        }
    } else {
                        ...
                        <div class="tab-content mb-6">
                            ...
                            <div class="tab-pane" id="account-details">
                                ...
                                <form class="form account-details-form" action="#" method="post">
                                    ...
                                    <input type="submit" class="btn btn-dark btn-rounded btn-sm mb-4" name="change_details" value="Save Changes">
                                </form>
                            </div>
                            <div class="tab-pane" id="account-password-change">
                                <form class="form account-details-form" method="post">
                                    ...
                                    <input type="submit" class="btn btn-dark btn-rounded btn-sm mb-4" value="Save Changes" name="change_password" id="change_password">
                                </form>
                            </div>
                        </div>
                    </div>
