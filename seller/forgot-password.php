...
<body class="hold-transition login-page">
  ...
  if (isset($_POST["submit"])) {
    ...
    $query = mysqli_query($connection, "select * from tbl_seller where seller_email='{$email}'") or die(mysqli_error($connection));
    ...
    if ($count > 0) {
      ...
      $adminemail = $row['seller_email'];

      $adminpassword = $row['seller_password'];
