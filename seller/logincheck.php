...
<body>
   ...
   if (isset($_POST["submit"])) {
      ...
      $query = mysqli_query($connection, "select *from tbl_seller where seller_email='{$email}' and seller_password='{$password}' and is_verify=1") or die(mysqli_error($connection));
      ...
      if ($count > 0) {
         ...
         $ad_name = $row['seller_first_name'];


         $_SESSION["selleremail"] = $email;
         $_SESSION["sellername"] = $ad_name;
