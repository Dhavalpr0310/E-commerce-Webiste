                    ...
                    <div class="shop-content">
                        ...
                        <div class="main-content">
                            <div class="product-wrapper row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                                <?php
                                if (isset($_GET['id'])) {
                                    $products = mysqli_query($connection, "SELECT *from tbl_product_master where category_id='{$_GET['id']}' order By product_id ASC");
                                } else {
                                    $products = mysqli_query($connection, "SELECT *from tbl_product_master order By product_id ASC");
                                }
